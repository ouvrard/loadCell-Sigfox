...
const int analogvalA = 512.5; 	// Analog reading taken with load A on the load cell

// Second data pair
const float loadB = 500;		// Load B
const int analogvalB = 661.5; 	// Analog reading taken with load B on the load cell
